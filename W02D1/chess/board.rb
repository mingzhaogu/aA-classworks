...
class Board
  ...
  def setup
    ...
    self[[7,4]] = Rook.new(:white, self, [7,4])
    self[[7,5]] = Bishop.new(:white, self, [7,5])
    self[[7,6]] = Rook.new(:white, self, [7,6])
